...
RULE_TAGS: dict[str, tuple[str, str]] = {
    ...
    "llm-prompt-injection-fstring": ("CWE-1427", "LLM01:2025 - Prompt Injection"),
    "llm-prompt-injection-format": ("CWE-1427", "LLM01:2025 - Prompt Injection"),
    "llm-prompt-concatenation": ("CWE-1427", "LLM01:2025 - Prompt Injection"),
    "llm-direct-user-passthrough": ("CWE-1427", "LLM01:2025 - Prompt Injection"),
    "llm-output-to-exec": ("CWE-94", "LLM02:2025 - Insecure Output Handling"),
    "llm-output-innerhtml": ("CWE-79", "LLM02:2025 - Insecure Output Handling"),
    "llm-langchain-python-repl": ("CWE-94", "LLM08:2025 - Excessive Agency"),
    "llm-langchain-shell-tool": ("CWE-78", "LLM08:2025 - Excessive Agency"),
    "llm-langchain-sql-agent": ("CWE-89", "LLM08:2025 - Excessive Agency"),
    "llm-langchain-dangerous-code": ("CWE-94", "LLM08:2025 - Excessive Agency"),
    "llm-langchain-verbose-leak": ("CWE-532", "LLM06:2025 - Sensitive Information Disclosure"),
    "llm-rag-url-loader": ("CWE-829", "LLM03:2025 - Training Data Poisoning"),
    "llm-rag-no-chunk-auth": ("CWE-284", "LLM06:2025 - Sensitive Information Disclosure"),
    "llm-missing-max-tokens": ("CWE-770", "LLM04:2025 - Data and Model Denial of Service"),
    "llm-client-side-openai": ("CWE-798", "LLM06:2025 - Sensitive Information Disclosure"),
    "llm-system-prompt-client": ("CWE-200", "LLM07:2025 - System Prompt Leakage"),
    "llm-chat-route-no-rate-limit": ("CWE-770", "LLM04:2025 - Data and Model Denial of Service"),
    "llm-auto-tool-approval": ("CWE-284", "LLM08:2025 - Excessive Agency"),
    "llm-pickle-serialization": ("CWE-502", "LLM03:2025 - Training Data Poisoning"),
    "llm-crewai-code-execution": ("CWE-94", "LLM08:2025 - Excessive Agency"),
    "llm-instructor-unchecked": ("CWE-20", "LLM02:2025 - Insecure Output Handling"),
    "llm-no-guardrails-detected": ("CWE-693", "LLM09:2025 - Misinformation"),
}
